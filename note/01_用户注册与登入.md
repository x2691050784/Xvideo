...
2. 用户注册  
   ...
   * 实现user.xml与数据库交互
   ...
   <mapper namespace="com.imooc.bilbil.dao.UserDao">
    <select id="getUserByPhone" parameterType="java.lang.String" resultType="com.imooc.bilbil.domain.User">
        select
            *
        from
            t_user
    ...
    <insert id="addUser" parameterType="com.imooc.bilbil.domain.User" useGeneratedKeys="true" keyProperty="id">
    insert into
    ...
    <insert id="addUserInfo" parameterType="com.imooc.bilbil.domain.UserInfo">
        insert into
...
3. 在 `com/imooc/bilbil/service/util` 下创建 TokenUtil类 (暂时测试用)
   ```java
